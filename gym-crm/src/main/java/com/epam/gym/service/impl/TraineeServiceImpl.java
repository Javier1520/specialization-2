...
public class TraineeServiceImpl implements TraineeService {
    ...
    public List<TrainingResponse> getTraineeTrainings(
            String username, TrainingFilterRequest filter) {
        logUtils.info(
                log,
    ...
    public List<TrainerInfoResponse> getTrainersNotAssignedToTrainee(String traineeUsername) {
        logUtils.info(
                log, "Get not assigned trainers request: traineeUsername={}", traineeUsername);
    ...
    private void validatePasswordLength(String password) {
        Optional.ofNullable(password)
                ...
                .orElseThrow(
                        () -> new ValidationException("Password must be at least 10 characters"));
    }
    ...
    private void cancelFutureTrainingsForTrainee(String username) {
        ...
        trainings.stream()
                ...
                .forEach(training -> {
                    ...
                    DeleteWorkloadRequest workloadRequest = DeleteWorkloadRequest.builder()
