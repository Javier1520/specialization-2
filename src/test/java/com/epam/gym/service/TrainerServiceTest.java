...
class TrainerServiceTest {
    ...
    void setUp() {
        registrationRequest = new TrainerRegistrationRequest(
                "Tr", "Ai", TrainingType.Type.CARDIO);
    }

    @Test
    void createTrainer_success_generatesUsernameAndSaves() {
        Trainer mappedTrainer = Trainer.builder()
                .firstName("Tr")
                .lastName("Ai")
                .specialization(TrainingType.Type.CARDIO)
                .build();
        Trainer saved = Trainer.builder()
                .id(5L)
                .username("tr.ai")
                .password("pw")
                .isActive(true)
    ...
    void updateTrainer_notFound_throws() {
        UpdateTrainerRequest request = new UpdateTrainerRequest(
                "no", "New", "Name", TrainingType.Type.STRENGTH, true);
    ...
    void updateTrainer_whenTrainerExists_updatesAndReturnsTrainer() {
        ...
        UpdateTrainerRequest request = new UpdateTrainerRequest(
                "trainer.user", "New", "Name", TrainingType.Type.STRENGTH, true);
