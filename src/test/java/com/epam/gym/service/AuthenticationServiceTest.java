...
class AuthenticationServiceTest {
    ...
    class AuthenticateTests {
        ...
        void authenticate_validTrainee_success() {
            ...
            when(refreshTokenService.createRefreshToken("trainee1")).thenReturn(new RefreshToken(1L, "refresh-token", "trainee1", Instant.now()));
        ...
        void authenticate_validTrainer_success() {
            ...
            when(refreshTokenService.createRefreshToken("trainer1")).thenReturn(new RefreshToken(1L, "refresh-token", "trainer1", Instant.now()));
            when(passwordEncoder.matches("password123", "password123")).thenReturn(true);
    ...
    class ChangePasswordTests {
        ...
        void changePassword_invalidNewPassword_throwsValidationException(String newPassword) {
            ValidationException exception = assertThrows(
                    ValidationException.class,
                    () -> authenticationService.changePassword("trainee1", "oldpass123", newPassword)
            );
    ...
    class RefreshTokenTests {
        ...
        void refreshToken_validToken_success() {
            ...
            RefreshToken refreshToken = new RefreshToken(1L, refreshTokenStr, "trainee1", Instant.now().plusSeconds(3600));
