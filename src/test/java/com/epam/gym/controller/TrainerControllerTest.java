...
class TrainerControllerTest {
  ...
  void updateProfile_success_returnsOk() {
    ...
    UpdateTrainerRequest request =
        new UpdateTrainerRequest(username, "Updated", "Trainer", TrainingType.Type.CARDIO, true);
    ...
    ResponseEntity<TrainerProfileResponse> response =
        trainerController.updateProfile(username, request);
  ...
  void getTrainings_success_returnsOk() {
    ...
    when(trainerService.getTrainerTrainings(username, filter)).thenReturn(trainingResponses);
