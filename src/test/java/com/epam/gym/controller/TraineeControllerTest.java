...
class TraineeControllerTest {
  ...
  void register_success_returnsCreated() {
    ...
    RegistrationResponse registrationResponse = new RegistrationResponse("john.doe", "password123");
  ...
  void getNotAssignedTrainers_success_returnsOk() {
    ...
    List<TrainerInfoResponse> trainerInfos =
        List.of(new TrainerInfoResponse("trainer1", "Trainer", "One", TrainingType.Type.CARDIO));
