...
class SecurityConfigTest {
    ...
    @MockBean
    private com.epam.gym.workload.service.WorkloadService workloadService;
    ...
    // Note: WebMvcTest asks for a controller, if none is provided it might fail to start if it scans for them.
    ...
    // Since we don't have a controller mapped in this test slice, checking 401 on valid path or 404 is tricky.
